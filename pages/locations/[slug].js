...
export default function locationDetail({ location }) {
    ...
    return (
        <>
        <Seo
            title={location?.seo?.title_tag}
            description={location?.seo?.meta_description}
            image={urlFor(location?.image).quality(50).url()}
        />
        <Header
            title={location?.name}
        />
                            ...
                            <div className="md:flex gap-10">
                                ...
                                <div className="md:w-2/3">
                                    ...
                                    <div className="mt-14">
                                        ...
                                        <a href={`tel:${location.contactInformation.phoneNumber}`} className="secondary-button">Call</a>
                                    </div>
                                </div>
                            </div>
                        </div>
